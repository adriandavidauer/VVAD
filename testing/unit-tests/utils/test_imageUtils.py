...
class TestImageUtils(unittest.TestCase):
    ...
    def test_detect_face(self):
        testImgPath = "./testData/imgUtils_image_example.jpg"

        self.assertNotEqual(False, imgUtils.getRandomFaceFromImage(load_local_img(testImgPath)))

    # Returns False as no face is existent in the example image
    def test_detect_no_face(self):
        testImgPath = "./testData/imgUtils_image_neg_example.jpg"

        self.assertEqual(False, imgUtils.getRandomFaceFromImage(load_local_img(testImgPath)))
