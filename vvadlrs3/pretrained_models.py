...
def get_face_img_model():
    ...
    """
    return load_model(str(base_path) + "/best_models/2021/bestFaceEndToEnd.h5")
...
def get_lip_img_model():
    ...
    """
    return load_model(str(base_path) + "/best_models/2021/bestLipEndToEnd.h5")
...
def get_face_feature_model():
    ...
    """
    return load_model(str(base_path) + "/best_models/2021/faceFeatureModel.h5")
...
def get_lip_feature_model():
    ...
    """
    return load_model(str(base_path) + "/best_models/2021/lipFeatureModel.h5")
...
def get_face_img_model_path():
    ...
    """
    return str(base_path) + "/best_models/2021/bestFaceEndToEnd.h5"
...
def get_lip_img_model_path():
    ...
    """
    return str(base_path) + "/best_models/2021/bestLipEndToEnd.h5"
...
def get_face_feature_model_path():
    ...
    """
    return str(base_path) + "/best_models/2021/faceFeatureModel.h5"
...
def get_lip_feature_model_path():
    ...
    """
    return str(base_path) + "/best_models/2021/lipFeatureModel.h5"
