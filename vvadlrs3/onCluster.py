...
if __name__ == "__main__":
    ...
    parser.add_argument("task", help='what should be done', type=str,
                        choices=['timeSteps', 'imageSize', 'bestLipEndToEnd', 'bestFaceEndToEnd', 'FeatureTimeSteps',
    ...
    if args.task == 'timeSteps':
        ...
        for timeStep in timeSteps:
            ...
            history = model.fit(x=train_x_parted, y=train_y_parted, validation_data=validation_data_parted,
                                batch_size=batch_size, epochs=epochs)
            num_samples = 'all' if not train_samples else train_samples
            Models.saveHistory(history.history,
                               "../trainingHistories/onCluster_{}_{}_{}_{}_{}.pickle".format(num_samples, modelName,
        ...
        for image_size in image_sizes:
            ...
            history = model.fit(x=train_x_resized, y=train_y_resized, validation_data=validation_data_resized,
                                batch_size=batch_size, epochs=epochs)
            num_samples = 'all' if not train_samples else train_samples
            Models.saveHistory(history.history,
                               "../trainingHistories/IMAGEEVAL{}_{}_{}_{}_{}.pickle".format(num_samples, modelName,
                                                                                            batch_size, input_shape,
                                                                                            datetime.datetime.now()))
        ...
        num_samples = 'all' if not train_samples else train_samples
        Models.saveHistory(history.history,
                           "../trainingHistories/onCluster_{}_{}_{}_{}_{}_{}.pickle".format(args.task, num_samples,
        ...
        for timeStep in timeSteps:
            ...
            num_samples = 'all' if not train_samples else train_samples
            Models.saveHistory(history.history,
                               "../trainingHistories/onClusterFeatureLSTM_{}_{}_{}_{}_{}.pickle".format(num_samples,
                                                                                                        modelName,
                                                                                                        batch_size,
                                                                                                        input_shape,
                                                                                                        datetime.datetime.now()))
